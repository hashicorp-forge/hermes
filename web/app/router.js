...
Router.map(function () {
  ...
  this.route("authenticated", { path: "/" }, function () {
    ...
    //TODO: Keeping this route for testing purpose. Will be removed later.
    this.route("document-view", { path: "/document/:document_id/view" }, function () {
      console.log("Matched document-view route with dynamic segment `:document_id`");
    });
